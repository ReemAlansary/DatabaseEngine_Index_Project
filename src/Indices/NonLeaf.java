...
public class NonLeaf extends Node {
	...
	//RTREE
	public NonLeaf(RTree tree, String parent) {
		super(tree, parent);
		this.min = (int) Math.ceil((tree.n+1)/2.0) - 1;
		entries = new ArrayList<NodeEntry>();
	...
	public void mergeWithNonLeaf(BPTree tree, NonLeaf sibling, NonLeaf parent, boolean left, int parentIdx,String inTmpPath) {
...
//			}
	...
	///////////////////////////////////////RTREEEEEEEEEEEEEEEE/////
	public void mergeWithNonLeaf(RTree tree, NonLeaf sibling, NonLeaf parent, boolean left, int parentIdx,String inTmpPath) {
